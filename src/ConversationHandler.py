class ConversationHandler:
    ...
    states = {
        ...
        1: ("Hey ich habe Zeit, was möchtest Du tun?",
            "1: Willst Du mit jemandem sprechen? Ich kenne interessante Chat-Partner, die sich auf Dich freuen! = " +
            emoji["smiling"] +
            "\n: Oder willst Du etwas Neues ausprobieren? Ich habe da ein paar coole Tipps für Dich! = " + emoji[
                "muscle"]),
